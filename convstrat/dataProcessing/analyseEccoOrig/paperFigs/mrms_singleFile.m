...
basedir=['/scr/cirrus1/rsfdata/projects/convstrat/mdv/mrmsConus3D/conv_strat/20210503/'];

infile='20210503_010640.mdv.cf.nc';
...
lonBig=double(round(ncread(file,'x0'),3));
latBig=round(ncread(file,'y0'),3);

alt=ncread(file,'z1');

reflBig=ncread(file,'Dbz3D');
part2Dbig=ncread(file,'Partition2D');
part3Dbig=ncread(file,'Partition3D');

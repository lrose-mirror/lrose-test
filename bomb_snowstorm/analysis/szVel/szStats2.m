...
infileList={'svel43-4W-3TS-WIDE03SNR.txt';
'svel43-4W-3TS-WIDE05SNR.txt';
'svel43-4W-3TS-WIDE10SNR.txt'};

cm=turbo(32);

figure('Position',[200 500 1100 400],'DefaultAxesFontSize',12);
colormap(flipud(cm));
...
print([figdir,'szStats2.png'],'-dpng','-r0')
